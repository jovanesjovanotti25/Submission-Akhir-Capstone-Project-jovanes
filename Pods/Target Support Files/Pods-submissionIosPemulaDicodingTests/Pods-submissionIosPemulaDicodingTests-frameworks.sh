...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "${BUILT_PRODUCTS_DIR}/Alamofire-iOS15.5/Alamofire.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/Kingfisher-iOS15.5/Kingfisher.framework"
